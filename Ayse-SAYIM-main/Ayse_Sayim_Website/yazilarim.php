        ...
        <?php $yazilar = yazi_getir(); while($yazi = mysqli_fetch_assoc($yazilar)): ?>
            <div class="card">
                <div class="card-header">
                    <h5>
                        <?php echo $yazi['baslik'] .'<small class="fw-bold fs-6 fst-italic ms-2 text-secondary"></small>'  ;   ?>
                    </h5>
                </div>
                <div class="card-body">
                    ...
                    <span style="font-size: 16px;" class="fw-bold fst-italic text-secondary float-start my-2">(<?php echo $yazi['kategori']; ?>)</span>
